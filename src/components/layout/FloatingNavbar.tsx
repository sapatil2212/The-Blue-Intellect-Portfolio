      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3">
            <ThemeToggle />
            <a
              href="/tbi-Portfolio.pdf"
              download="tbi-Portfolio.pdf"
              className="text-xs font-bold text-neutral-600 dark:text-neutral-400 hover:text-neutral-950 dark:hover:text-neutral-50 transition-all px-4 py-2.5 rounded-full border border-neutral-200/50 dark:border-neutral-850 hover:bg-neutral-50 dark:hover:bg-neutral-900/50 flex items-center gap-1.5 cursor-pointer active:scale-95 shadow-xs"
            >
              <span>Portfolio</span>
              ...
              <motion.div variants={itemVariants} className="flex flex-col gap-6 mt-auto">
                ...
                <div className="flex flex-col gap-3 text-left">
                  <a
                    href="/tbi-Portfolio.pdf"
                    download="tbi-Portfolio.pdf"
                    className="text-center text-sm font-bold text-neutral-600 dark:text-neutral-400 py-3.5 rounded-xl border border-neutral-200/50 dark:border-neutral-850 hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-colors flex items-center justify-center gap-2 cursor-pointer"
                  >
